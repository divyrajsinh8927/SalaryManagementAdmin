@php
    $active_menu = '';
    $active_sub_menu = '';
    if (isset($meta_data) && isset($meta_data['menu'])) {
        $active_menu = $meta_data['menu'];
    }
@endphp
...
<aside
    ...
    <div class="h-19">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap dark:text-white text-slate-700"
            ...
            <img src="{{ config('app.asset_url') }}assets/img/logo-ct-dark.png"
                class="inline h-full max-w-full transition-all duration-200 dark:hidden ease-nav-brand max-h-8"
                alt="main_logo" />
            <img src="{{ config('app.asset_url') }}assets/img/logo-ct.png"
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            <li class="mt-0.5 w-full">
                <a class="py-2.7 bg-blue-500/13 dark:text-white dark:opacity-80 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold text-slate-700 transition-colors {{ $active_menu == 'dashboard' ? 'active_nav' : '' }}"
                    href="{{ config('app.admin_url') }}">
                    <div
