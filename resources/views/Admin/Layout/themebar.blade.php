<div fixed-plugin>
    <a fixed-plugin-button
        class="fixed px-3 py-1 text-xl bg-white shadow-lg cursor-pointer bottom-8 right-8 z-990 rounded-circle text-slate-700">
        <i class="py-1 pointer-events-none ni ni-settings-gear-65 text-3xl"> </i>
    </a>
